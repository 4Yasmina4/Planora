<!-- Molecule: dit bestand bevat één tabelrij met gebruikersgegevens en actieknoppen
-->

<template>
    <tr class="border border-ocean-twilight hover:bg-ghost-white/60 transition">
        <!-- Gebruikersgegevens -->
