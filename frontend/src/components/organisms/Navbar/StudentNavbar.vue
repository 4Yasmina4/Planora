<!-- Organism: dit bestand bevat de studentnavbar
     Het combineert de StudentNavbarLinks molecule met een logo en uitlogknop
-->
...
<template>
    <nav class="bg-soft-periwinkle shadow-sm">
        ...
        <div class="flex items-center justify-between gap-4 px-4 md:px-16 py-6">
            ...
            <!-- Navbar linkjes (alleen grote schermen) -->
...
<script setup>
    ...
    import StudentNavbarLinks from '../../molecules/Navbar/StudentNavbarLinks.vue'
